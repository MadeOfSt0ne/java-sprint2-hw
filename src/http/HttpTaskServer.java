...
public class HttpTaskServer {
    ...
    public HttpTaskServer() throws IOException {
        ...
        server.createContext("/tasks/", this::findPrioTasks);
        server.createContext("/tasks/history", this::findHistory);
        server.createContext("/tasks/subtask/epic/?id=", this::findSubsByEpicId);
    }
    ...
    // получение отсортированного списка (по времени начала)
    private void findPrioTasks(HttpExchange h) throws IOException {
        try {
            System.out.println("\n/tasks/");
    ...
    // получение истории
    private void findHistory(HttpExchange h) throws IOException {
        try {
            System.out.println("\n/tasks/history");
            if (h.getRequestMethod().equals("GET")) {
    ...
    // поиск подзадач по id эпика
        private void findSubsByEpicId(HttpExchange h) throws IOException {
            try {
